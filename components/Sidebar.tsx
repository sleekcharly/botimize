    ...
    <div className="bg-white text-white p-5">
      <ul className="gap-5 flex lg:flex-col">
        <li className="flex-1">
          <Link
            href="/create-chatbot"
            className="hover:opacity-50 flex flex-col text-center lg:text-left lg:flex-row items-center gap-2 p-5 rounded-md bg-[#c46477]"
          >
            <BotMessageSquare className="h-6 w-6 lg:h-8 jg:w-8" />
        ...
        <li className="flex-1">
          <Link
            ...
            className="hover:opacity-50 flex flex-col text-center lg:text-left lg:flex-row items-center gap-2 p-5 rounded-md bg-[#c46477]"
          >
            <PencilLine className="h-6 w-6 lg:h-8 jg:w-8" />
            <div className="hidden md:inline">
        ...
        <li className="flex-1">
          <Link
            ...
            className="hover:opacity-50 flex flex-col text-center lg:text-left lg:flex-row items-center gap-2 p-5 rounded-md bg-[#c46477]"
          >
            <SearchIcon className="h-6 w-6 lg:h-8 jg:w-8" />
            <div className="hidden md:inline">
